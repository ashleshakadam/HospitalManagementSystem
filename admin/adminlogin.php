...
?></div>
    ...
    <div class="card">
		<h1 class="title"> <a href="index.php" Style="font-size: 15px;color:#1d3557;">Back</a></h1>
        <h1 class="title"><span>Hospital Management System</span>Admin <span class="msg">Sign in to start your session</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
                    ...
                    <div class="text-center"> <a href="doctorlogin.php">Doctors Login</a></div>
                </div>
            </form>
        </div>
    </div>    
