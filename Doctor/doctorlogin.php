...
?></div>
    ...
    <div class="card">
        ...
        <h1 class="title"><span>Hospital Management System</span>Doctors <span class="msg">Hello, Doctor!</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
                    ...
                    <div class="text-center"> <a href="adminlogin.php">Admin Login</a></div>
                </div>
            </form>
        </div>
    </div>    
