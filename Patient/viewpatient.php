  ...
  <section class="container">
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <tbody>
       ...
       $sqlap ="SELECT * FROM appointment";
       $qsqlap = mysqli_query($con,$sqlap);
       while($rs = mysqli_fetch_array($qsql))
       {
		   
		   $rss = mysqli_fetch_array($qsqlap);
        echo "<tr>
        ...
        if(isset($_SESSION[adminid]))
        {
          ...
          <a href='patientreport.php?patientid=$rs[patientid]&appointmentid=$rss[appointmentid]' class='btn btn-sm btn-raised bg-cyan'>View Report</a>";
        }
        echo "</td></tr>";
      }
      ?>
